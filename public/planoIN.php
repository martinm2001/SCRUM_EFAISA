...
<head>
    ...
    <title>Plano <?php echo $nroin ?></title>
...
<body>
    ...
    <main class="contprinc">
        <nav class="navbar navbar-default ">
            ...
            <div style="display: inline-flex;">
                ...
                <h3 class="headerConfig">Plano <?php echo $nroin ?></h3>
            </div>
        </nav>
            ...
            if (isset($_REQUEST['guardar'])) {
                if (isset($_FILES['foto']['name'])) {
                    ...
                    if (in_array($tipoArchivo, $permitido) == false) {
                        ...
                        header("Refresh:2; url=planoIN.php?nroin=$nroin");
                    }
                    ...
                    $query = "UPDATE planosin SET nombre = '$nombreArchivo', imagen = '$binariosImagen', tipo = '$tipoArchivo' WHERE id=$nroin;
                    ";
    ...
    <footer id="footer">
        <script>
            crearBotonFooter(`planosMenu.html`, "img/boton_cruz.png");
        </script>
    </footer>
</body>
